...
def FSC_patch(complex1,complex2):  
    ...
    R1_CM = CM.CM(R1)
    complex1 = np.roll(complex1,Rcenter[0]-R1_CM[0],axis=0)
    complex1 = np.roll(complex1,Rcenter[1]-R1_CM[1],axis=1) #將R1質心移至array中心
    ...
    complex2 = np.roll(complex2,corrMax[0][0]-corrCenter[0],axis=0)
    complex2 = np.roll(complex2,corrMax[1][0]-corrCenter[1],axis=1) #將R2移至與R1最重合的位置
